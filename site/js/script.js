...
(function () {
	...
	// Inicialize scripts que requerem uma página carregada
	...
	$(function () {
		...
		/**
		 * @desc Inicialize a dica de ferramenta do Bootstrap com o posicionamento necessário
		...
		// Classe adicional em html se mac os.
		if (navigator.platform.match(/(Mac)/i)) {
			$html.addClass("mac-os");
		}

		// Adiciona algumas funcionalidades perdidas aos navegadores IE (IE Polyfills)
		if (isIE) {
		...
		// Dicas de ferramentas de inicialização
		...
		// Ano dos direitos autorais (avalia o ano correto dos direitos autorais)
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF255': 'Ah, droga! Algo deu errado.'
				};
